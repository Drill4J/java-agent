...
import com.epam.drill.agent.jacoco.BooleanArrayProbeInserter
import com.epam.drill.agent.common.module.*
import com.epam.drill.agent.jacoco.BooleanArrayProbeInserter.*
...
class DrillClassInstrumenter(
    ...
    override fun visitMethod(
        ...
        val frameEliminator: MethodVisitor =
            DrillDuplicateFrameEliminator(mv)

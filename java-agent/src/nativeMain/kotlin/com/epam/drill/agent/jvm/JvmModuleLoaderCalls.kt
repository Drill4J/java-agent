...
internal fun callObjectAgentModuleMethodWithString(clazz: KClass<out Any>, method: String, string: String?) =
...
internal fun callObjectAgentModuleMethodWithString(clazz: KClass<out Any>, method: KCallable<Any?>, string: String?) =

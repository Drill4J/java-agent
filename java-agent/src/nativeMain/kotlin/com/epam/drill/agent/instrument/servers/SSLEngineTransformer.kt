...
actual object SSLEngineTransformer : Transformer, AbstractTransformerObject() {

    override fun enabled() = super<AbstractTransformerObject>.enabled() && Configuration.parameters[INSTRUMENTATION_SSL_ENABLED]
}

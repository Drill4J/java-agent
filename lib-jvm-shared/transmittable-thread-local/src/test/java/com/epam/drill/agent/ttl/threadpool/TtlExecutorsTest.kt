...
import com.epam.drill.agent.ttl.threadpool.ExecutorServiceTtlWrapper
import com.epam.drill.agent.ttl.threadpool.ExecutorTtlWrapper
import com.epam.drill.agent.ttl.threadpool.ScheduledExecutorServiceTtlWrapper
...
class TtlExecutorsTest : AnnotationSpec() {
    ...
    fun test_getTtlRunnableUnwrapComparator__common() {
        ...
        getTtlRunnableUnwrapComparator(comparator).let {
            ...
            //   failed to access class com.epam.drill.agent.ttl.threadpool.TtlUnwrapComparator
            //     from class com.epam.drill.agent.ttl.threadpool.TtlExecutorsTest
            //   (com.epam.drill.agent.ttl.threadpool.TtlUnwrapComparator is in unnamed module of loader 'bootstrap';
            //     com.epam.drill.agent.ttl.threadpool.TtlExecutorsTest is in unnamed module of loader 'app')
            assertEquals("com.epam.drill.agent.ttl.threadpool.TtlUnwrapComparator", it!!.javaClass.name)

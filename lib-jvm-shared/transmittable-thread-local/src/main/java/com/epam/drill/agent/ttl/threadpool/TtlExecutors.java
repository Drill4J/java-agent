...
public final class TtlExecutors {
     ...
     * it's allowed to submit the {@link TtlRunnable}/{@link TtlCallable} to the wrapped Executor;
     ...
     * <p>
     * About idempotency: if is idempotent,
     * it's allowed to submit the {@link TtlRunnable}/{@link TtlCallable} to the wrapped ExecutorService;
     * otherwise throw {@link IllegalStateException}.
     *
     ...
     * <p>
     * About idempotency: if is idempotent,
     * it's allowed to submit the {@link TtlRunnable}/{@link TtlCallable} to the wrapped ScheduledExecutorService;
     * otherwise throw {@link IllegalStateException}.
     *
    ...
    /**
     * Wrapper of {@code Comparator<Runnable>} which unwrap {@link TtlRunnable} before compare,

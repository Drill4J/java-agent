...
import static com.epam.drill.agent.ttl.threadpool.agent.internal.transformlet.impl.Utils.isClassOrInnerClass;
import static com.epam.drill.agent.ttl.threadpool.agent.internal.transformlet.impl.Utils.isClassUnderPackage;
...
public class TtlTransformer implements ClassFileTransformer {
    ...
    // [ERROR] com.epam.drill.agent.ttl.threadpool.agent.TtlTransformer.transform(ClassLoader, String, Class, ProtectionDomain, byte[])

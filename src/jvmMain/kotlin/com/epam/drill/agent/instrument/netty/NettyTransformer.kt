            ...
            ctClass.run {
                getMethod("invokeChannelRead", "(Ljava/lang/Object;)V").wrapCatching(
                    ...
                    """
                        if ($1 instanceof $DefaultHttpRequest) {
                            ...
                            ${NettyStorage::class.java.name}.INSTANCE.${NettyStorage::storeDrillHeaders.name}(allHeaders);
                        }
                    """.trimIndent()
                )
                ...
                writeMethod.wrapCatching(
                    ...
                    """
                        ...
                        if ($1 instanceof $DefaultHttpRequest) {
                            $DefaultHttpRequest nettyRequest = ($DefaultHttpRequest) $1;
                            java.util.Map drillHeaders = ${NettyStorage::class.java.name}.INSTANCE.${NettyStorage::loadDrillHeaders.name}();
                ...
                writeMethod.wrapCatching(
                    ...
                    """
                        if ($1 instanceof $DefaultHttpResponse) {
                            ...
                            ${NettyStorage::class.java.name}.INSTANCE.${NettyStorage::clearDrillHeaders.name}();
                        }
                    """.trimIndent()
                )
                toBytecode()
